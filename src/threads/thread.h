...
struct user_prog_of_thread {
   char *programName;                /* Name of the user program */
   struct list childThreads;         /* List of child threads */
   struct list fileDescriptorTable;  /* Table of file descriptors */
   int nextFileDescriptor;           /* Next file descriptor value to assign */
